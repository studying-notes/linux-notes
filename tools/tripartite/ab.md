---
date: 2022-05-17T16:21:20+08:00
author: "Rustle Karl"

title: "ab 服务器性能测试工具"
url:  "posts/linux/tools/tripartite/ab"  # 永久链接
tags: [ "Linux" ]  # 标签
...
```
ab -n 100000 -c 100 http://127.0.0.1:80/gitea/
```

#### 测试 1000 并发数情况下的服务能力

```
ab -n 100000 -c 1000 http://127.0.0.1:80/gitea/
```
