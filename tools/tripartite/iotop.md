---
date: 2022-05-17T13:49:36+08:00
author: "Rustle Karl"

title: "iotop 监视磁盘I/O使用状况的工具"
url:  "posts/linux/tools/tripartite/iotop"  # 永久链接
tags: [ "Linux" ]  # 标签
...
**iotop 命令** 是一个用来监视磁盘 I/O 使用状况的 top 类工具。iotop 具有与 top 相似的 UI，其中包括 PID、用户、I/O、进程等相关信息。
